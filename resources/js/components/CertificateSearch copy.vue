    ...
    <div class="w-72">
      <Combobox v-model="selectedCertificate">
        <div class="relative mt-1">
          ...
          <div v-if="query !== ''" class="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
            <div
